    ...
    onCustomAction(event) {
        ...
        case 'verify':
            if(event.status == "Submitted"){
                this.router.navigate(['form',{buttons: this.params.buttons,moduleUrl: this.params.moduleUrl,action: event.action, fields: event.fields, data: event.id, moduleName: this.params.title,headerObject: this.params.headerObject,apiPath: this.params.apiPath, formType: this.params.formType, listType: this.params.listType}] , {  relativeTo: this.route.parent, skipLocationChange: true });
            }else{
                alert("The Client has already verified");
            }
           break;
        case 'view':
            this.router.navigate(['form',{buttons: this.params.buttons,moduleUrl: this.params.moduleUrl,action: event.action, moduleId: this.params.moduleId, fields: event.fields, data: event.id, moduleName: this.params.title,headerObject: this.params.headerObject,apiPath: this.params.apiPath, listType: this.params.listType}] , {  relativeTo: this.route.parent, skipLocationChange: true });
           break;
        case 'cancel':
