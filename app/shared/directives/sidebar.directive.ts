...
export class SidebarDirective implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private cdr: ChangeDetectorRef, private router: Router, private configService: ConfigService, private layoutService: LayoutService, private route: ActivatedRoute) {
