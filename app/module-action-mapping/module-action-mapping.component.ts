...
@Component({
    selector: 'master-app',
    templateUrl: './module-action-mapping.component.html',
    styleUrls: ['./module-action-mapping.component.scss']
})

export class ModuleActionMappingComponent implements OnInit {
