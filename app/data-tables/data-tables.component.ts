...
export class DataTablesComponent implements OnInit {
  ...
  gotoform(){
    this.router.navigate(['/forms/sampleForm'],{  relativeTo: this.route.parent, skipLocationChange: true })
  }
  gotosettings(){
    this.router.navigate(['/pages/account-settings'],{  relativeTo: this.route.parent, skipLocationChange: true })
  }
}
