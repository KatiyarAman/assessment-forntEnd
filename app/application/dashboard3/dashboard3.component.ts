...
export class TourdModalContents1 implements OnInit {
...
export class Dashboard3Component implements OnInit {
  ...
  ngOnInit(){
    ...
    environment.returnUrl = this.route.snapshot['_routerState'].url
    environment.event = JSON.stringify(this.route.snapshot.params)
    this.openContent();
  }
  ...
  openContent() {
      const modalRef = this.modalService.open(TourdModalContents1);
  }
