...
@Component({
    selector: 'master-app',
    templateUrl: './item-service-request.component.html',
    styleUrls: ['./item-service-request.component.scss']
})

export class ItemServiceRequestComponent implements OnInit {
