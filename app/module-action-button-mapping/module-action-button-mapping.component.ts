...
@Component({
    selector: 'master-app',
    templateUrl: './module-action-button-mapping.component.html',
    styleUrls: ['./module-action-button-mapping.component.scss']
})

export class ModuleActionButtonMappingComponent implements OnInit {
