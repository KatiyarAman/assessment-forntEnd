...
export class PopupFormDesign implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        switch (this.params.action) {
            ...
            case 'edit':
                this.fieldList = []
                console.log(this.params.headerObject)
                this.fieldList = JSON.parse(this.params.headerObject)
                // this.formData = JSON.parse(this.params.formData)
                // console.log(this.formData)
                this.getCustomFields();
    ...
    getFormFields() {
        ...
        let displayFields = 0
        console.log(this.fieldList)
        let hiringRounds=this.fieldList.filter(x=>x.fieldName == "hiringRounds")[0]
        if(hiringRounds!=null){this.showRound=true}
        // console.log(module)
