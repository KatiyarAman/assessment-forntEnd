...
export class CustomFormDesign implements OnInit, AfterViewInit {
    ...
    getOptions(fields, value, object, parentFieldId, level) {
        ...
        // console.log(fields)
        environment.api_url = environment.login_url + "/module";
        this.appService.getById(fields.srcModule, 120,25).subscribe(module => {
            // console.log(module)
    ...
    getData() {
        ...
        this.appService.getById(this.params.data, this.params.moduleId,26).subscribe(data => {
            console.log(data)
            this.formData = data
            console.log(this.formData)
            this.setDataValues();
        ...
        this.fieldList.forEach(fields => {
            if (fields.fieldType != 'table' && fields.fieldType != 'object' && fields.fieldType != 'Section' && fields.fieldType != 'multipleCheck' && fields.entryType != 'UDF' && fields.fieldType != 'file') {
                ...
                if (fields.fieldName == 'cityId') {
                    ...
                    this.appService.getById(this.formData[fields.fieldName], fields.srcModule,27).subscribe(data => {
                        console.log(data);
            ...
            if (fields.fieldType == 'table') {
                ...
                if (fields.srcModule != null) {
                    ...
                    if(this.formData.jobPostingId){
                        ...
                        this.appService.getById(this.formData.jobPostingId,fields.srcModule,28).subscribe(posting=>{
                                    ...
                                    fields.childCustomFields.forEach(ch => {
                                        if (ch.fieldType == 'select' || ch.fieldType == 'autoCompleter' || ch.fieldType == 'multiSelect') {
                                            switch (ch.fieldName) {
                                                case 'cityId':
                                                    environment.api_url = environment.login_url + "/city";
                                                    this.appService.getById(childData[ch.fieldName], ch.srcModule,29).subscribe(data => {
                                                        let city = data
                                                        console.log(city)
