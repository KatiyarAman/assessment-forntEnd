...
export const HROUTES = [                     
  ...
  {
    path: '', title: 'Master', icon: 'ft-home', class: 'dropdown nav-item has-sub', isExternalLink: false,
    submenu: [
      {
        path: '', title: 'Admin Setup', icon: 'ft-arrow-right submenu-icon', class: 'has-sub', isExternalLink: false,
        submenu: [
          { path: '/master', title: 'Company Master', icon: 'ft-arrow-right submenu-icon', class: 'dropdown-item', isExternalLink: false, submenu: [] },
        ]
      },
    ]
  },
  ...
  },
  {
    ...
    submenu: [
      ...
      { path: '/forms/sampleForm', title: 'Sample Form', icon: 'ft-arrow-right submenu-icon', class: 'dropdown-item', isExternalLink: false, submenu: [] },
