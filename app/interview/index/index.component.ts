...
export class IndexComponent implements OnInit {
    ...
    onCustomAction(event) {
        ...
        case 'add':
            ...
            this.router.navigate(['form',{buttons: this.params.buttons,moduleUrl: this.params.moduleUrl,action: event.action, moduleId: this.params.moduleId, fields: event.fields, title: this.params.title,headerObject: this.params.headerObject,apiPath: this.params.apiPath, listType: this.params.listType}] , {  relativeTo: this.route.parent, skipLocationChange: true });
            break;
        case 'edit':
            // this.routerService.pushRouterHistory(this.router);
            this.router.navigate(['form',{buttons: this.params.buttons,moduleUrl: this.params.moduleUrl,action: event.action, moduleId: this.params.moduleId, fields: event.fields, data: event.id, title: this.params.title,headerObject: this.params.headerObject,apiPath: this.params.apiPath, listType: this.params.listType}] , {  relativeTo: this.route.parent, skipLocationChange: true });
            break;
        case 'verify':
            // this.routerService.pushRouterHistory(this.router);
            if(event.status == "Submitted"){
                this.router.navigate(['form',{buttons: this.params.buttons,moduleUrl: this.params.moduleUrl,action: event.action, fields: event.fields, data: event.id, title: this.params.title,headerObject: this.params.headerObject,apiPath: this.params.apiPath, listType: this.params.listType}] , {  relativeTo: this.route.parent, skipLocationChange: true });
            }else{
