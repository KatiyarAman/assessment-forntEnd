...
import { PurchaseBillBookRoutingModule } from "./purchase-bill-book-routing.module";
...
@NgModule({
    imports: [
        ...
        NgSelectModule,
        HttpClientModule,
        PurchaseBillBookRoutingModule,
        CustomDataTableModule,
        CustomFormModule
    ],
    declarations: [
        PurchaseBillBookComponent,
        IndexComponent,
        FormComponent, 
        // NgbdModalContent
       // ViewComponent
...
export class PurchaseBillBookModule { }
