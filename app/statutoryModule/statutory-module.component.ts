...
@Component({
    selector: 'statutorydetails-app',
    templateUrl: './statutory-module.component.html',
    styleUrls: ['./statutory-module.component.scss']
})

export class StatutoryModuleComponent implements OnInit {
