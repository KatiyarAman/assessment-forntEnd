...
import { MeasurementUnitConversionRoutingModule } from "./measurement-unit-conversion-routing.module";
...
@NgModule({
    imports: [
        ...
        NgSelectModule,
        HttpClientModule,
        MeasurementUnitConversionRoutingModule,
        CustomDataTableModule,
        CustomFormModule
    ],
    declarations: [
        MeasurementUnitConversionComponent,
        IndexComponent,
        FormComponent,
        // NgbdModalContent
       // ViewComponent
...
export class MeasurementUnitConversionModule { }
