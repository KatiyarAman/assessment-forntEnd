...
import { CandidatesApplicationRoutingModule } from './candidates-application.routing.module';
...
@NgModule({
    imports: [
        ...
        NgSelectModule,
        HttpClientModule,
        CandidatesApplicationRoutingModule,
...
export class CandidatesApplicationModule { }
