...
@Component({
    selector: 'master-app',
    templateUrl: './measurement-unit-conversion.component.html',
    styleUrls: ['./measurement-unit-conversion.component.scss']
})

export class MeasurementUnitConversionComponent implements OnInit {
